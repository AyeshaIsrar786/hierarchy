...
<html lang="en">
    ...
    <body class="bg-gray-100">
        ...
        fetchProductData() {
            const category_id = this.selectedCategoryId ? this.selectedCategoryId : 'null';
            axios.get('/products/view?category_id=${category_id}')
            .then((response) => {
              ...
              <div class="flex justify-center">
                ...
                >
                  Add Category
                    ...
                    x-on:dblclick.prevent="handleDoubleClick(category.id)"
