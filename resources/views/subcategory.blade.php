...
x-data="{
        ...
        fetchProductData(id) {
      axios.get(`/products/subcategory/${id}`)
        .then((response) => {
        ...
        submitCategoryForm() {
            ...
            axios.post('/', this.formData)
                .then((response) => {
                    ...
                    this.fetchCategoryData(this.subcategory_id);
                    location.reload();
                })
                .catch((error) => {
        ...
        submitProductForm() {
            axios.post('/products', this.formData)
                .then((response) => {
                    ...
                    this.formData.name = '';
                    this.formData.parent_id = '';
                    this.fetchProductData(this.subcategory_id);
        ...
        handleDoubleClick(categoryId) {
            ...
            window.location.href = '/supplier/' + categoryId;
        },
        initialize() {
            this.fetchCategoryData(this.subcategory_id);
            this.fetchProductData(this.subcategory_id);
                  ...
                  Add SubCategory
                    ...
                    <div class="mt-8">
                        ...
                        <template x-for="category in categories" :key="category.id">
                                <li x-on:click.prevent="toggleProductForm(category.id)"                     x-on:dblclick.prevent="handleDoubleClick(category.id)" class="flex items-center mr-4 mb-4">
